...
MINIMUM_SUPPORTED_AZURE_OPENAI_PREVIEW_API_VERSION = "2023-03-15-preview"
...
def _create_setting_for_model(env_prefix: str) -> _AzureOpenAISettings:
    ...
    #     env_ignore_empty=True
    # )
    class _DynamicAzureOpenAISettings(_AzureOpenAISettings):
        model_config = config_dict


    return _DynamicAzureOpenAISettings()
    # return _AzureOpenAISettings(env_prefix=env_prefix)

class _AppSettings(BaseModel):
    base_settings: _BaseSettings = _BaseSettings()
    azure_openai: _AzureOpenAISettings = _create_setting_for_model("AZURE_OPENAI_")
    azure_gpt_35: _AzureOpenAISettings = _create_setting_for_model("AZURE_GPT_35_")
